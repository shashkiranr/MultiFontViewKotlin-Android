package fyi.library.multifonttextclockkotlin
...
class MultiFontTextClockKotlin : TextClock {
    ...
    private fun initializeCustomTypeface(attrs: AttributeSet?, context: Context) {
        if (attrs != null) {
            ...
            val attributesArray = context.obtainStyledAttributes(attrs,
                    R.styleable.MultiFontTextClockKotlin)
            val fontID = attributesArray.getInt(R.styleable.MultiFontTextClockKotlin_typeface_from_list, -1)
    ...
    companion object {
        ...
        private val LOG_TAG = "MultiFontTCKotlin" // TC due to 23 characters TAG restriction
    }
