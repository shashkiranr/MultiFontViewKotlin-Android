package fyi.library.multifontbuttonkotlin
...
class MultiFontButtonKotlin : android.support.v7.widget.AppCompatButton {
    ...
    private fun initializeCustomTypeface(attrs: AttributeSet?, context: Context) {
        if (attrs != null) {
            ...
            val attributesArray = context.obtainStyledAttributes(attrs,
                    R.styleable.MultiFontButtonKotlin)
            val fontID = attributesArray.getInt(R.styleable.MultiFontButtonKotlin_typeface_from_list, -1)
    ...
    companion object {
        ...
        private val LOG_TAG = "MultiFontButtonKotlin"
    }
}
