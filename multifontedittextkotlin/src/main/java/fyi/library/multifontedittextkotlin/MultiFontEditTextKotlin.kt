...
class MultiFontEditTextKotlin : android.support.v7.widget.AppCompatEditText {
    ...
    private fun initializeCustomTypeface(attrs: AttributeSet?, context: Context) {
        if (attrs != null) {
            ...
            val attributesArray = context.obtainStyledAttributes(attrs,
                    R.styleable.MultiFontEditTextKotlin)
            val fontID = attributesArray.getInt(R.styleable.MultiFontEditTextKotlin_typeface_from_list, -1)
    ...
    companion object {
        ...
        private val LOG_TAG = "MultiFontEditTextKotlin"
    }
