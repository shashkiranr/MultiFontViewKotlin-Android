package fyi.library.mutifonttextviewkotlin
...
class MultiFontTextViewKotlin : android.support.v7.widget.AppCompatTextView {
    ...
    private fun initializeCustomTypeface(attrs: AttributeSet?, context: Context) {
        if (attrs != null) {
            ...
            val attributesArray = context.obtainStyledAttributes(attrs,
                    R.styleable.MultiFontTextViewKotlin)
            val fontID = attributesArray.getInt(R.styleable.MultiFontTextViewKotlin_typeface_from_list, -1)
    ...
    companion object {
        ...
        private val LOG_TAG = "MultiFontTextViewKotlin"
    }
